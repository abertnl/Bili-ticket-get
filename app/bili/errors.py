...
ERROR_MESSAGES: dict[int, str] = {
    ...
    100016: "项目状态不可售",
    100017: "票种不可售",
    100034: "票价错误，需刷新价格后重试",
    100039: "活动太火爆了，请稍后再试",
    100041: "对未发售的项目下单",
    100044: "需要完成人机验证",
    100048: "已经下单，请勿重复下单",
    100050: "登录态失效，请重新登录",
    100051: "订单准备已过期，需要重新预下单",
    100079: "重复订单或已有订单",
    219: "下单失败，请重试",
    221: "下单请求过多，请稍后再试",
    900001: "前方拥堵，请重试",
    900002: "当前请求较多，请稍后再试",
    209001: "本项目需要联系人信息或暂不支持当前购买方式",
...
_FATAL_CODES = {-101, -111, 100016, 100017, 100050, 209001}
# 售罄类
_SOLD_OUT_CODES = {100009}
# 风控
_RISK_CODES = {-352, 100044}
# 限流/风控拦截类
_RATE_LIMIT_CODES = {3, 221, 412, 429, 900002}
